...
$RemoveString = 'REDACTEDSTRING\'
# List of default Users to exclude from Shared Malbox access
$DefaultFullAccessUsers = [System.Collections.ArrayList]@(
    'NT AUTHORITY\SELF'
    'REDACTEDSTRING\Domain Admins'
    'REDACTEDSTRING\Enterprise Admins'
    'REDACTEDSTRING\Organization Management'
    'REDACTEDSTRING\Administrator'
    'REDACTEDSTRING\Exchange Servers'
    'REDACTEDSTRING\Exchange Domain Servers'
    'REDACTEDSTRING\Public Folder Management'
    'NT AUTHORITY\SYSTEM'
    'NT AUTHORITY\NETWORK SERVICE'
    'REDACTEDSTRING\Delegated Setup'
    'REDACTEDSTRING\Exchange Trusted Subsystem'
    'REDACTEDSTRING\Exchange Services'
    'REDACTEDCRED'
    'BUILTIN\Administrators'
    'REDACTEDCRED'
    'Everyone'
    'NT AUTHORITY\ANONYMOUS LOGON'
    'REDACTEDSTRING\Discovery Management'
)
